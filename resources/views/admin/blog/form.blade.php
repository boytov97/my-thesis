            ...
            <div class="form_wrapper">
                <form action="{{ route($route, ['id' => $entity->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row col__wrapper">
                        <div class="col-md-6">
                            <div class="input__wrapper">
                                <label class="input__label">Тема</label>
                    ...
                    <div class="row col__wrapper">
                        ...
                        <div class="col-md-6">
                            @include('admin.common.forms.files', ['field' => 'file', 'slug' => 'audio', 'accept' => 'audio/*'])
                        </div>
                    </div>
                    ...
                    <div class="row col__wrapper">
                        <div class="col-md-6">
                            <div class="input__wrapper">
                                <label class="input__label">Тааныш эмес сөздөр</label>
                                <textarea name="unf_words" class="textarea__adm_min {{ $errors->has('unf_words') ? 'error_i' : '' }}">{!! $entity->unf_words ?: old('unf_words') !!}</textarea>
                                @if ($errors->has('unf_words'))
                                    <span class="error__message">{{ $errors->first('unf_words') }}</span>
                                @endif
                            </div>
                        </div>
